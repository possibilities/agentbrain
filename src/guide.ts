export function buildGuide(): unknown {
  return {
    ...
    recommended_workflow: [
      "Run `agentbrain stats --json` if you need to understand available source types/tags.",
      ...
      "Cite document_id, chunk_id when applicable, and source_uri in your answer.",
      "Do not infer absence from one failed search; try alternate terms before saying the cache has no relevant material.",
    ],
    commands: {
      stats: "Inventory counts, source types, tags, recent docs.",
      search:
